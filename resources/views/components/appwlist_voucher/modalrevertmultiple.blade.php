...
<div class="modal" style="display: block;" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <textarea wire:model='revertconsernmodel' required name="remark_reject" rows="4"
                ...
                <span>
                    <button type="submit" wire:click='revert' class="btn btn-danger mt-3">Revert</button>
                </span>
            </div>
        </div>
    </div>
