...
<div wire:click="closeshowai" class="bg-dark opacity-50" style="height: 100%;width: 100%;left: 0;top: 0;overflow: hidden;position: fixed;"></div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <div>
                        ...
                        <a class="btn btn-success btn-sm" href="{{ route('suppliers.create') }}" target="_blank">Tambah
                            Supplier
                            Baru</a>
                    </div>
            ...
            <div class="modal-footer">
                <button class="btn" wire:click="closeshowsp" x-on:click="open = false">Cancel</button>
                <button class="btn btn-primary" wire:click="saveprice" wire:loading.attr="disabled" x-on:click="open = false">Save</button>
            </div>
            <script>
