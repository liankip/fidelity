...
<body class="A5">
    ...
    <article>
        ...
        <div style="display: flex; justify-content:space-between; margin-bottom: 8px">
            ...
            <div style="font-size: 12px; font-weight: bold; margin-top: 6px; width: 50%">
                {{-- <address style="font-size: 12px; font-weight: bold; margin-top: 6px"> --}}
                @foreach ($po_data as $key => $val_po_data)
                    <p style="margin-bottom: 5px">{{ $val_po_data->supplier->name }}</p>
                    <p style="margin-bottom: 5px">{{ $val_po_data->supplier->address }} </p>
                    <p>{{ $val_po_data->supplier->city }}, {{ $val_po_data->supplier->province }}</p>
                @endforeach
                {{-- </address> --}}
            </div>
            ...
            <div style="display: flex;justify-content: space-between; width: 50%">
                ...
                <div style="width: 80%">
                    ...
                    <table style="width: 100%;">
                        ...
                        @foreach ($po_data as $val_po_data)
                            <tr>
                                <th style="width: 25%">Number #</th>
                                <td>{{ $val_po_data->po_no }}</td>
                            </tr>
                        @endforeach
                        <tr>
                            <th>Date</th>
                ...
                @foreach ($po_detail as $keydtail => $val_po_data_detail)
                    ...
                    <tr>
                        ...
                        <td>{{ str_replace(',00', '', number_format($val_po_data_detail->qty, 2, ',', '.')) }}
                            {{ $val_po_data_detail->prdetail->unit }}</td>
                        <td>
                            <br>
                            <p></p>
                            {{-- Nama Driver : {{ $drivermemo->driver_name }}
                            <br>
                            Plat Kendaraan : {{ $drivermemo->vehicle }} --}}
                        </td>
                        {{-- <td><span data-prefix>Rp. </span>{{ number_format($val_po_data_detail->price,2) }}</td>
                        <td><span data-prefix>Rp. </span>{{ number_format($val_po_data_detail->amount,2) }}</td> --}}
                    </tr>
                @endforeach
                {{-- <tr>
    ...
    <div style="display: flex; justify-content: space-between">
        ...
        {{-- <table class="balance">
            ...
            <tr>
                <th>Total</th>
                <td><span data-prefix>Rp. </span>{{ number_format($total_amount,2) }}</td>
            </tr>
            <tr>
                <th>Tax</th>
        ...
        {{-- {{ $drivermemo->driver_name }} ( {{ $drivermemo->vehicle }} ) --}}
