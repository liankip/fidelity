    ...
    <style>
        ...
        *[contenteditable]:focus,
        ...
        @page:first {
            ...
            margin: 0;
            margin-bottom: 20%/* Adjust the margin size as needed */
        }
    ...
    <article>
        <div style="display: flex; justify-content: space-between; margin-bottom: 8px">
            ...
            <div style="font-size: 12px; margin-top: 6px; font-weight: bold;width: 50%">
                ...
                <p style="margin-bottom: 5px">{{ $po_data->supplier->address }} <br>
                ...
                <div style="width: 90%">
                    <table style="width: 100%">
                        <tr>
                            <td colspan="2">
                                ...
                                {{-- {{ $our_company->city}} , {{ $our_company->province}} <br> --}}
                    ...
                    <table class="" style="width: 100%">
                        ...
                        {{-- <tr>
                            ...
                            <td>
                                @if ($getproject_name)
                                    {{ $getproject_name->name }}
                                @endif
                            </td>
                        </tr> --}}
                        {{-- <tr>
                            <th>Company Name</th>
                            <td>{{ $getproject_name->company_name }}</td>
                        </tr> --}}
                        {{-- <tr>
                            <th>NPWP</th>
                            <td>95.920.324.1-121.000</td>
                        </tr> --}}

                        {{-- <tr>
                                <th>Supplier</th>
                                <td>{{ $val_po_data->supplier->name }}</td>
                            </tr> --}}
                        <tr>
                            <th>Payment Term</th>
                        ...
                        {{-- <tr>
                            <th>Amount Due</th>
                            <td><span id="prefix">Rp.</span><span>{{ number_format($total_amount,2)  }}</span></td>
                        </tr> --}}
        ...
        <table class="inventory">
            <thead>
                <tr style="width: 100%">
                    ...
                    <th style="width: 35%"><span>Product Description</span></th>
                    {{-- <th>Type</span></th> --}}
            ...
            <tbody>
                @foreach ($po_detail as $keydtail => $val_po_data_detail)
                    ...
                    <tr style="width: 100%">
                        ...
                        <td style="text-align: center; width: 15%">{{ $val_po_data_detail->prdetail->purchaseRequest->partof ?? '-' }}</td>

                        {{-- <td>{{ $val_po_data_detail->prdetail->item_name }}</td> --}}
                        <td style="text-align:left">{{ $val_po_data_detail->item->name }}
                            ...
                            @else
                                <br><br>
                                <p style="text-align:left">
                                    <small><b>Product desc:</b>
                                        {{ $val_po_data_detail->prdetail ? $val_po_data_detail->prdetail->item_name : $val_po_data_detail->item->name }}</small>
                                </p>
                            @endif
                        ...
                        <td>{{ str_replace(',00', '', number_format($val_po_data_detail->qty, 2, ',', '.')) }}
                            {{ $val_po_data_detail->prdetail ? $val_po_data_detail->prdetail->unit : $val_po_data_detail->unit }}
                        </td>
                        <td><span data-prefix>
    ...
    <aside>
        ...
        <table class="balance">
            ...
            @php
                $tarifds = 0;
            @endphp
            @if ($po->deliver_status == 2)
                <tr>
                    <th>Ongkos Kirim</th>
                    <td>
                        <div style="display: flex;justify-content: space-between">
                            <span data-prefix>Rp. </span>
                            <div>{{ number_format($po->tarif_ds, 0, ',', '.') }}</div>
                        </div>
                    </td>
                </tr>
                @php
            ...
            <tr>
                ...
                <td style="font-weight: bold"><span data-prefix>
                        <div style="display: flex;justify-content: space-between">
                            <span data-prefix>Rp. </span>
                            <div>{{ number_format($amount + $tarifds + $tax, 0, ',', '.') }}</div>
                        </div>
            </tr>
            {{-- @endforeach --}}
