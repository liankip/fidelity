...
<body>
    ...
    <article>
        ...
        <table class="meta">
            ...
            @foreach ($po_data as $val_po_data)
                <tr>
                    <th>Payment Term</th>
                    <td>{{ $val_po_data->term_of_payment }}</td>
                </tr>
            @endforeach
            <tr>
                <th>Amount Due</th>
                <td><span id="prefix">Rp.</span><span>{{ $total_amount }}</span></td>
            </tr>
            ...
            <tbody>
                @foreach ($po_detail as $val_po_data_detail)
                    <tr>
                        ...
                        <td>{{ $val_po_data_detail->id }}</td>
                        <td>{{ $val_po_data_detail->item_id }}</td>
                        <td>{{ $val_po_data_detail->qty }}</td>
                        <td><span data-prefix>Rp. </span>{{ $val_po_data_detail->price }}</td>
                        <td><span data-prefix>Rp. </span>{{ $val_po_data_detail->amount }}</td>
                    </tr>
                @endforeach
                {{-- <tr>
    ...
    <aside>
        ...
        <table class="balance">
            ...
            <tr>
                <th>Total</th>
                <td><span data-prefix>Rp. </span>{{ $total_amount }}</td>
            </tr>
            <tr>
                <th>Tax</th>
                <td>{{ $total_tax }} <span data-prefix>%</span></td>
            </tr>
            <tr>
                <th>Balance Due</th>
                <td><span data-prefix>Rp. </span>{{ $total_amount }}</td>
        ...
        <img id='barcode'
            ...
            alt="" title="SNE" width="100" height="100" />
        <div>
            <br>
            <p>{{ $our_company->name }}<br> Telp. {{ $our_company->phone }}</p>
        </div>
    </aside>
</body>
