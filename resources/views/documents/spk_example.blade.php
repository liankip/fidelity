<html>
	...
	<body>
		...
		<article>
			<h1>Recipient</h1>
			<address>
				<p>PT. Satria Nusa Engineering</p>
                <p>Jl. Kartini Dalam No.11 <br>Madras Hulu, Medan Polonia</p>
        ...
        <tr>
				...
				<tr>
					<th>Amount Due</th>
					<td><span id="prefix">Rp.</span><span>213</span></td>
				</tr>
                <tr>
					<th>Payment Term</th>
					<td>CoD</td>
      ...
      <table class="balance">
				...
				<tr>
					<th>Tax</th>
					<td><span data-prefix>Rp. </span>0.00</td>
				</tr>
				<tr>
					<th>Balance Due</th>
					<td><span data-prefix>Rp. </span>213</td>
      ...
      <input id="text" type="text"
            value="Satria Nusa Engineering" style="Width:0%"
      ...
      <img id='barcode'
			...
			<div >
                <br>
				<p>Satria Nusa Engineering <br> Telp. 081534617975</p>
			</div>
		</aside>
	</body>
</html>
