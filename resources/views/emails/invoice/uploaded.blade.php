...
<body>
    <span class="preheader">
        Invoice for PO No. {{ $po->po_no }} has been uploaded
    </span>
                                            ...
                                            <div class="flex justify-center">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            {{ date('Y-m-d', strtotime($receipt->date_received)) }}
                                                        </td>
                                                    </tr>
                                                    @if ($po->top_date)
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td>
                                                                {{ date('Y-m-d', strtotime($po->top_date)) }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                </table>
                                                ...
                                                border-collapse: collapse;">
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td style="font-weight: bold">:
                                                                ...
                                                                @else
                                                                    @php
                                                                        $getamount = App\Helpers\GetAmount::get($po);
                                                                    @endphp
                                                                    {{ rupiah_format($getamount['total']) }}
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <p>
                                                        This Purchase Order can now be scheduled for payment. you
                                                        can schedule payment by clicking the button below.
                                                    </p>

                                                    <div class="">
                                                        <a href="{{ route('payment-waiting-lists', ['po' => $poNumber]) }}"
