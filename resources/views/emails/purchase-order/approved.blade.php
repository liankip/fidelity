...
<head>
    ...
    <title>
        Purchase Order with No. PO {{ $po->po_no }} has been approved.
    </title>
    <style>
        /* -------------------------------------
      GLOBAL RESETS
                                                ...
                                                <div class="flex justify-center">
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td>
                                                                {{ $po->project ? $po->project->name : 'Stok Persediaan Gudang' }}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <p><br></p>
                                                            ...
                                                            @foreach ($po->podetail as $key => $val)
                                                                <tr>
                                                                    ...
                                                                    border-collapse: collapse; padding-left: 5px">
                                                                        {{ $val->prdetail ? $val->prdetail->item_name : $val->item->name }}</td>
                                                                    <td
                                                                        style="padding:8px;border: 1px solid black;
                                                                    border-collapse: collapse; text-align: center">
                                                                        {{ (int) $val->qty }} {{ $val->unit }}
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                            </tbody>
