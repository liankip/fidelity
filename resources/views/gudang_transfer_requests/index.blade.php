    ...
    <div class="container mt-2">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left">
                    <h2>{{ config('app.company', 'SNE') }} - ERP | Gudang Transfer Request Page</h2>
                </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="pull-right mb-2">
                    <a class="btn btn-success" href="{{ route('gudang_transfer_requests.create') }}"> New GTR</a>
                </div>
            </div>
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    @foreach ($gudang_transfers as $key => $gudangtransfer)
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <form action="{{ route('gudang_transfers.destroy', $gudangtransfer->id) }}" method="Post">
                                    ...
                                    <a class="btn btn-primary"
                                        href="{{ route('gudang_transfers.edit', $gudangtransfer->id) }}">Create GT</a>
                                    <a class="btn btn-primary"
