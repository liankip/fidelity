...
@section('content')
    <div class="container mt-2">
        ...
        @endif
        <form action="{{ route('gudang_transfers.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="gt_no"
                                    value="{{ $idxs->idx }}/GT/{{ env('NO_PREFIX') }}/{{ $returnValueRoman }}/{{ $year }}"
                                    class="form-control" placeholder="gt_no">
