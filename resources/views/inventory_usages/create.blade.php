...
@section('content')
    <div class="container mt-2">
        ...
        @endif
        <form action="{{ route('inventory_usages.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-primary" href="{{ route('inventory_usages.index') }}"> Back</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Usages No:</strong>
                                <input readonly type="text" name="iu_no" class="form-control" placeholder="iu_no"
                                    value="@foreach ($idxs as $idxs){{++$idxs->idx}}@endforeach/IU/{{ env('NO_PREFIX') }}/{{ $returnValueRoman }}/{{ $year }}">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select name="to" id="to" class="js-example-basic-single form-control"
                                    ...
                                    <option value="">Pilih Destination Project</option>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="iu_no"
                                    value="{{ $idxs->idx }}/IU/{{ env('NO_PREFIX') }}/{{ $returnValueRoman }}/{{ $year }}"
                                    class="form-control" placeholder="iu_no">
