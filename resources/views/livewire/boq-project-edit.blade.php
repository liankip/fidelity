<div wire:ignore>
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left mb-2">
                <h2>Add BOQ Project Item</h2>
                <h4 class="text-secondary"><strong>{{ $project->name }} | {{ $task->task }}
                        - {{ $task->task_number }}</strong>
                </h4>
                <hr class="">
            </div>
        </div>
    ...
    <script type="text/javascript"
            src="{{ asset('/assets/js/handsontable/plugins/handsontable.full.min.js') }}"></script>
