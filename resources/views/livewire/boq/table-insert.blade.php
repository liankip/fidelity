<div wire:ignore>
    ...
    <script>
        ...
        (function($) {
            var dataObject = [];
            var hotElement = document.querySelector('#boqTable');
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        renderer: function(instance, td, row, col, prop, value, cellProperties) {
                            ...
                            // Call the default numeric renderer
                            Handsontable.renderers.NumericRenderer.apply(this, arguments);
                        },
                        editor: 'numeric',
            ...
            hot.addHook('afterChange', function(changes, src) {
                ...
                // Autosave
                setTimeout(() => {
                    Livewire.emit('autosave', JSON.stringify(getHotData(hot)));
                }, 500);
        ...
        function getHotData(hot) {
            ...
            // filter data, lewati jika ada baris data yang memiliki item kosong
