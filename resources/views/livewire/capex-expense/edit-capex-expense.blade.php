    ...
    <div class="card mt-5 primary-box-shadow">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12 mt-2">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" wire:model="project_name">
                        @error('project_name')
                ...
                <div class="col-md-12 mt-2">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" wire:model="total_budget">
                        @error('total_budget')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="text-end">
                ...
                <button class="btn btn-primary ml-3" wire:click="edit"><i
