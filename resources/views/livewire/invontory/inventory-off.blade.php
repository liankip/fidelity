...
<div>
    ...
    <h2>Barang Keluar</h2>
    <hr>
    {{-- <button class="btn btn-info" wire:click="toggleDraft">{{ $draftStatus ? 'All Items' : 'Draft Items' }}</button> --}}
    <a class="btn btn-info" href="{{ route('inventory.draft') }}">Listed Items</a>
    @if($projectmodel)
        ...
        <div class="card mt-5">
            <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model.debounce.150ms='projectmodel' name="project_id" id="project_id"
