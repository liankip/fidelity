<div class="container">
    <div class="row justify-content-center">
        ...
        {{-- <button wire:click="showcart">showdata</button> --}}
        {{-- @include('livewire.cartpr') --}}
        <div class="col-7">
            <div class="row">
                    ...
                    <div class="col-sm-4 mt-2">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex">
                                ...
                                <input type="hidden" value="{{ $item->unit }}" name="unit">
                                <input type="hidden" value="{{ $item->type }}" name="type">
                                <input type="hidden" value="{{ $item->price }}" name="price">
                                <input type="hidden" value="{{ $item->image }}" name="image">
                                <input type="hidden" value="1" name="quantity">
                                <button class="btn btn-success">Add to PR</button>
                            </form> --}}


                                <button wire:click="additem({{ $item->id }})" class="btn btn-success" style="font-size: 12px">Add to
                                    PR</button>
                        ...
                        @if (count($itemsarray))
                            @foreach ($itemsarray as $key => $item)
                                <tr>
                                    ...
                                    <td><input class="form-control" style="font-size: 12px"  wire:model="itemsarray.{{ $key }}.count" wire:blur="updateqty({{$key}})"
                                            type="number" min="1"></td>
                                    <td style="min-width: 150px"><textarea name="" style="font-size: 12px" class="form-control" wire:model="itemsarray.{{ $key }}.note" wire:blur="updatenote({{$key}})" id="" cols="8" rows="2"></textarea> </td>
                                    <td style="font-size: 12px"><button class="btn btn-danger" wire:click="removeitem({{$key}})"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
