                        ...
                        <div class="col">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <a href="{{ asset('storage/' . $fileUpload) }}" target="_blank"
                                        class="btn btn-sm btn-warning mt-1">Download Dokumen Saat Ini</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <button wire:click.prevent="update({{ $edit_id }})" wire:loading.remove type="submit"
