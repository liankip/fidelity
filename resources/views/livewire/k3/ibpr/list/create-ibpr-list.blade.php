                        ...
                        <div class="row mb-2">
                            <div class="col">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">*</span>
                                        <div>
                                            <input type="text" wire:model="risk" class="form-control">
                                        </div>
                                        @error('risk')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div>
                                                ...
                                                <span class="text-danger">*</span>
                                                <input type="number" wire:model="risk_l" class="form-control">
                                            </div>
                                            <div>
                                                <label for="exampleInputEmail1" class="form-label">S</label>
                                                <span class="text-danger">*</span>
                                                <input type="number" wire:model="risk_s" class="form-control">
                                            </div>
                                            <div>
                                                <label for="exampleInputEmail1" class="form-label">RFN</label>
                                                <span class="text-danger">*</span>
                                                <input type="number" wire:model="risk_rfn" class="form-control">
                                            </div>
                                        </div>
                                        @error('risk_l')
                                            <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div>
                                                <label for="exampleInputEmail1" class="form-label">L</label>
                                                <span class="text-danger">*</span>
                                                <input type="number" wire:model="risk_l_left" class="form-control">
                                            </div>
                                            <div>
                                                <label for="exampleInputEmail1" class="form-label">S</label>
                                                <span class="text-danger">*</span>
                                                <input type="number" wire:model="risk_s_left" class="form-control">
                                            </div>
                                            <div>
                                                <label for="exampleInputEmail1" class="form-label">RFN</label>
                                                <span class="text-danger">*</span>
                                                <input type="number" wire:model="risk_rfn_left"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        @error('risk_l_left')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">*</span>
                                        <div>
                                            <select class="form-select" wire:model="risk_level_left"
                                                aria-label="Default select example">
                                                <option hidden>Pilih tingkat resiko</option>
                                                <option value="Acceptable">Acceptable</option>
                                                <option value="Trivial">Trivial</option>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    {{-- <span class="text-danger">*</span> --}}
                                    <div>
                                        <input type="text" wire:model="elimination" class="form-control">
                                    </div>
                                    @error('elimination')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <span class="text-danger">*</span> --}}
                                    <div>
                                        <input type="text" wire:model="substitution" class="form-control">
                                    </div>
                                    @error('substitution')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <span class="text-danger">*</span> --}}
                                    <div>
                                        <input type="text" wire:model="technical_control" class="form-control">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <span class="text-danger">*</span> --}}
                                    <div>
                                        <input type="text" wire:model="warning_control" class="form-control">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <span class="text-danger">*</span> --}}
                                    <div>
                                        <input type="text" wire:model="apd_usage" class="form-control">
                                    </div>
                                    @error('apd_usage')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <span class="text-danger">*</span> --}}
                                    <div>
                                        <input type="text" wire:model="target_achievement" class="form-control">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <span class="text-danger">*</span> --}}
                                    <div>
                                        <input type="text" wire:model="min_effective" class="form-control">
                                    </div>
                                    @error('min_effective')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <span class="text-danger">*</span> --}}
                                    <div>
                                        <input type="text" wire:model="new_risk" class="form-control">
                                    </div>
                                    @error('new_risk')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <span class="text-danger">*</span> --}}
                                    <div>
                                        <input type="text" wire:model="monitoring" class="form-control">
                                    </div>
                                    @error('monitoring')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger">*</span>
                                            <div>
                                                <input type="text" wire:model="cases.{{ $key }}.related_rules" class="form-control">
                                            </div>
                                            @error('related_rules')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
