    ...
    <div class="row">
        ...
        <div class="mt-2">
            <form action="POST" class="mb-2">
                ...
                @php
                    $cases = json_decode($hiradclist->data);
                @endphp
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    ...
                                                    <span class="text-danger">*</span>
                                                    <input type="number" wire:model="cases.{{ $key }}.risk_k"
                                                        class="form-control">
                                                </div>
                                                <div>
                                                    <label for="exampleInputEmail1" class="form-label">P</label>
                                                    <span class="text-danger">*</span>
                                                    <input type="number" wire:model="cases.{{ $key }}.risk_p"
                                                        class="form-control">
                                                </div>
                                                <div>
                ...
                <button wire:loading wire:target='update' type="submit" class="btn btn-secondary"
                    ...
                    <a href="{{ route('k3.hiradc.allList', $hiradc->id) }}" class="btn btn-secondary ">
                    Cancel
                </a>
            </form>
        </div>
