<div>
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h1>SOP (Standard Operating Procedure)</h1>
                <div class="alert alert-warning">
                    <strong>
                        Berikut merupakan form pembuatan SOP (Standard Operating Procedure)
                    </strong>
                </div>
                    ...
                    <tbody>
                        @forelse ($sops as $key => $item)
                            <tr wire:key="instruction-{{ $item->id }}"
                                ...
                                <td>
                                    <a href="{{ route('k3.sop.edit', $item->id) }}"
