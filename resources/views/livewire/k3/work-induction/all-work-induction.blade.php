        ...
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                ...
                <div class="alert alert-warning">
                    <strong>
                        Berikut merupakan form pembuatan Safety Induction (Induksi Keamanan)
                    </strong>
                </div>
    ...
    <div class="card mt-2">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('k3.workInduction.create') }}">
                ...
                <table class="table table-bordered fs-6 mt-4">
                    <thead class="thead-light text-center">
                        <tr class="text-center table-secondary">
                            ...
                            <th style="width: 13%" class="align-middle">Nama Petugas</th>
                            <th style="width: 13%" class="align-middle">Jabatan</th>
                            <th style="width: 6%" class="align-middle">File</th>
                            <th style="width: 7%" class="align-middle">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($work_inductions as $key => $item)
                            <tr wire:key="instruction-{{ $item->id }}"
                                ...
                                <td>
                                    <a href="{{ route('k3.workInduction.edit', $item->id) }}"
