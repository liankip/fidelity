        ...
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                ...
                <div class="alert alert-warning">
                    <strong>
                        Berikut merupakan form pembuatan Work Instruction (Instruksi Kerja)
                    </strong>
                </div>
    ...
    <div class="card mt-2">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('k3.workInstruction.create') }}">
            ...
            <div class="overflow-x-max">
                <table class="table table-bordered fs-6 mt-4">
                    ...
                    <tbody>
                        @forelse ($work_instructions as $key => $item)
                            <tr wire:key="instruction-{{ $item->id }}"
                                ...
                                <td>
                                    <a href="{{ route('k3.workInstruction.edit', $item->id) }}"
