<div>
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <div class="d-flex">
                    <a href="{{ route('k3.workInstruction') }}" class="btn btn-sm btn-secondary my-auto">
                        <i class="fa-solid fa-angle-left"></i>
                    </a>
                    <h2 class="my-auto">Instruksi Kerja
                    </h2>
                </div>
                <hr>
            </div>
        ...
        <div class="card mt-2">
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <a class="btn btn-secondary" href="{{ route('k3.workInstruction') }}">
                        Cancel
                    </a>
                </form>
            </div>
