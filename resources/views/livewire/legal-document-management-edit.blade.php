        ...
        <div class="card mt-2">
            <div class="card-body">
                <form method="POST">
                    ...
                    <button wire:click.prevent="edit({{ $edit_id }})" wire:loading.remove type="submit" class="btn btn-success">Edit</button>
                    <button wire:loading wire:target='edit' type="submit" class="btn btn-secondary"
