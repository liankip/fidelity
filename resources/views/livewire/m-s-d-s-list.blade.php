<div>
    <h1>MSDS (Material Safety Data Sheet)</h1>
    <div class="alert alert-warning">
        <strong>
            Berikut merupakan form pembuatan MSDS (Material Safety Data Sheet)
        </strong>
    </div>
    <hr>
    @if (session('success'))
    ...
    <div class="bg-white p-4" wire:ignore>
        <table class="table table-bordered" id="msdsTable">
            <thead>
                <th>No</th>
                <th>Document Name</th>
                <th>Action</th>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content" method="POST" action="{{ route('msds.create') }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            @if ($specificMSDS !== null)
                                <a href="{{ Storage::url($specificMSDS->file_upload) }}" target="__blank"
    ...
    <script>
        $(document).ready(function() {
            const dTable = new DataTable('#msdsTable', {
                ordering: false,
            });
        });
    </script>
