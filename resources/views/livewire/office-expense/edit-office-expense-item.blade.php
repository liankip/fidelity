            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" wire:model="purchase_date" disabled readonly>
                        @error('purchase_date')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            placeholder="Nama Penerima" wire:model="receiver_name">
                        @error('receiver_name')
                            <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" placeholder="vendor" wire:model="vendor">
                            @error('vendor')
                                <span class="error text-danger">{{ $message }}</span>
                            @enderror
                        </div>
