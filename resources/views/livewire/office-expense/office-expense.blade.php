<div class="mt-2">
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2 class="primary-color-sne">Office Expense</h2>
            </div>
            ...
            <div class="pull-right mb-2 mt-2 d-flex justify-content-between">
                <div class="d-flex gap-3">
                    <div class="mr-2">
                        <a class="btn btn-success" href="{{ route('office-expense.insert') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="text-align: center; display: flex; justify-content: center; gap: 5px;">
                                    <a href="{{ route('office-expense.edit', $d->id) }}"
                                        class="text-center btn btn-outline-primary">Edit</a>
                                    <a href="{{ route('office-expense.purchase', $d->id) }}"
