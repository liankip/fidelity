...
<div class="bg-white p-5">
     <form method="POST" action="{{ route('overtime.storeData') }}">
          @csrf
          <div class="form-group d-lg-flex justify-content-between gap-4">
               <div class="col-lg-6 d-flex flex-column gap-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                         <div class="col-lg-5">
                              ...
                              <input type="time" class="form-control" id="jam-mulai" name="start_time" required>
                         </div>
               ...
               <div class="col-lg-6 d-flex flex-column gap-4">
                    ...
                    <div>
                         ...
                         <textarea class="form-control" id="uraian-pelaporan-lembur" name="overtime_report" rows="3" required></textarea>
                    </div>

                    <div>
                         <div class="form-group">
                              <label for="estimasi-biaya-lembur">Estimasi Biaya Lembur <span class="text-danger">*</span></label>
                              <div class="d-flex border-black border p-1 rounded">
                                   ...
                                   <input type="text" class="form-control border-0" id="estimasi-biaya-lembur"
                                        name="est-cost" oninput="formatCurrency(this)" required>
          ...
          <div class="mt-4">
               <button type="submit" class="btn btn-success"
                    @if (session('success')) disabled @endif>Submit</button>
...
<script>
     ...
     function addSelect() {
          ...
          newSelectContainer.className = 'd-flex align-items-center justify-content-between mb-2';
