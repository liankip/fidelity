                        ...
                        <div class="mt-1 d-none d-lg-flex gap-2 ">
                            @if (auth()->user()->hasTopLevelAccess())
                                <div class="position-relative">
                                    <x-common.button-link :color="'primary'"
                                                          :route="route('boq.access.index', $project->id)"
                            ...
                            @if (auth()->user()->hasTopManagerAccess())
                                <div>
                                    <x-common.button-link :color="'primary'" class="btn-outline"
                                                          :route="route('boq.setting.index', $project->id)"
                    ...
                    <table id="boqTable" class="table table-bordered mt-3">
                        ...
                        <tr class="table-secondary">
                            @if (($adendum && auth()->user()->hasTopLevelAccess()) || (!$adendum && auth()->user()->hasTopLevelAccess()))
                                ...
                                <th class="text-center align-middle" width="10%">Nomor Engineering</th>
