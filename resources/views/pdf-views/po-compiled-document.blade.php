    ...
    <body>
        <div>
            ...
            <article>
                {{-- <h1>Recipient</h1> --}}
                <div>
                    <table style="border:none;font-size:100%">
                        <tr>
        ...
        <div>
            ...
            <div style="margin-top: 30px">
                @foreach ($po_data->invoices as $invoice)
                    <div style="max-width: 100%">
                        <img src="{{ asset($invoice->foto_invoice) }}" alt="" style="width: 100%;">
        ...
        <div>
            <h1>Foto Barang</h1>
            <div style="margin-top: 30px">
                @foreach ($po_data->submition->take(3) as $submition)
                    <div style="max-width: 100%">
                        <img src="{{ asset($submition->foto_barang) }}" alt="" style="width: 100%;">
                    </div>
                @endforeach
            </div>
        </div>
        ...
        <div>
            ...
            <div style="margin-top: 30px">
                @foreach ($po_data->payments as $payment)
                    <div style="max-width: 100%">
                        <img src="{{ asset($payment->payment_pict) }}" alt="" style="width: 100%;">
                    </div>
                @endforeach
            </div>
        </div>
