<html>
    ...
    <body>
        <header>
            @if ($get_prtype === null ||$get_prtype->pr_type == 'Barang')
                ...
                <tbody>
                    ...
                    @foreach ($po_detail as $keydtail => $val_po_data_detail)
                        ...
                        <tr style="width: 100%">
                            ...
                            <td>{{ $val_po_data_detail->prdetail->item_name ?? $val_po_data_detail->item->item_name }}</td>
                            <td>
                                {{ str_replace(',00', '', number_format($val_po_data_detail->qty, 2, ',', '.')) }}
                                {{ $val_po_data_detail->prdetail->unit ?? $val_po_data_detail->item->unit }}</td>
                            <td>
