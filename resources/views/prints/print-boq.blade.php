            ...
            <table class="inventory">
                <thead>
                    <tr style="width: 100%">
                        ...
                        <th style="width: 25%">Unit</span></th>
                        <th style="width: 25%">Price Estimation</span></th>
                        <th style="width: 25%">Total</span></th>
                    </tr>
                </thead>
                <tbody>
                    @php
                    ...
                    @foreach ($boqs as $boq)
                        <tr>
                            ...
                            <td>{{ (int) $boq->qty }}</td>
                            <td>{{ $boq->unit->name }}</td>
                            <td>{{ rupiah_format($boq->price_estimation) }}</td>
                            <td>
                                {{ rupiah_format($boq->price_estimation * $boq->qty) }}
                            </td>
                        </tr>
                        @php
                            $total += $boq->price_estimation * $boq->qty;
                        @endphp
                    @endforeach
                    <tr>
